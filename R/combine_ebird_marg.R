...
coordinates(df_postal)<-~coords.x1+ coords.x2
...
plot(poly_sf[i,]['CMAUID'], main=gsub("\\/.*", "",poly_all$CMANAME[i]), col=NA)
plot(da_crop['species_richness'],pal=viridis(50), add=T)
...
par(mar=c(0.5,0.5,0.5,0.5))
par(oma=c(0,0,1,4))
plot(da_crop['cmg06_11'],main=gsub("\\/.*","",poly_all$CMANAME[i]),pal=viridis,key.pos=4, nbreaks=50)
plot(poly[i,],add=T)
par(las=0)
...
par(oma=c(0,0,1,4))
layout(t(1:2), widths=c(6,1))
plot(poly[i,], main=gsub("\\/.*", "",poly_all$CMANAME[i]))
plot(da_crop['cmg06_13'],pal=viridis(50), add=T)
image(1,1:50,t(1:50), col=pal(50), axes=FALSE)
par(las=1)
axis(4,labels=c("lowest", "highest"),at=c(1,50), cex.axis=1)
par(las=0)
...
layout(t(1:2), widths=c(6,1))
plot(poly[i,], main=gsub("\\/.*", "",poly_all$CMANAME[i]))
plot(da_crop['cmg06_11'],pch=15, cex=2,pal=viridis(50), add=T)
image(1,1:50,t(1:50), col=pal(50), axes=FALSE)
par(las=1)
axis(4,labels=c("lowest", "highest"),at=c(1,50), cex.axis=1)
par(las=0)
...
layout(t(1:2), widths=c(6,1))
plot(poly[i,], main=gsub("\\/.*", "",poly_all$CMANAME[i]))
plot(da_crop['cmg06_12'],pal=viridis(50), add=T)
image(1,1:50,t(1:50), col=pal(50), axes=FALSE)
par(las=1)
axis(4,labels=c("lowest", "highest"),at=c(1,50), cex.axis=1)
par(las=0)
